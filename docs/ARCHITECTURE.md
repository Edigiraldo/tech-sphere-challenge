...
Piper. Adapters are selected at startup via configuration and wrapped behind a common
interface so the conversation module never depends on a specific provider.
